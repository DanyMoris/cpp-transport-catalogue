...
public:
    ...
    void LoadTransportData(const RequestHandler& handler) const;
...
private:
    ...
    json::Node MakeResponseOnRouting(int request_id, const json::Dict& map, const RequestHandler& handler) const;
};